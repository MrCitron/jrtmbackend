  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jrtmbackendApp.race.home.createOrEditLabel">
            <Translate contentKey="jrtmbackendApp.race.home.createOrEditLabel">Create or edit a Race</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : raceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="race-name" type="text" name="name" />
              </AvGroup>
