...
export const ProfessionDetail = (props: IProfessionDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="jrtmbackendApp.profession.detail.title">Profession</Translate> [<b>{professionEntity.id}</b>]
        </h2>
        ...
        <Button tag={Link} to="/profession" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfessionDetail);
